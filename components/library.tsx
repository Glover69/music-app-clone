...
const Library: React.FC = () => {
  ...
  return (
    <div className='flex flex-col gap-4'>
        ...
        <AiOutlinePlus onClick={onClick} size={20} className='text-[#727272] cursor-pointer hover:text-white transition'/>

        </div>
        <div className="">
            <div className="playlist-container flex flex-row items-center gap-6">
